...
var tostr = n => n.toString(36);

var hash = (str, maxLength = 8, salt = '') => {
  str = replace.replace('' + salt + str, /\r/g);
  var i = length.length(str);
  var hash = 60466176 + i;
  ...
  var res = tostr(hash >>> 0) + tostr(-hash >>> 0);
  return maxLength ? slice.slice(res, 0, maxLength) : res;
};
